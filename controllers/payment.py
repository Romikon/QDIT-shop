...
class PaymentRoutesController:
    ...
    def addCard(self):
        ...
        if type(newCard['number']) is not str and type(newCard['month']) is not str and type(
                newCard['year']) is not str and type(newCard['CVV']) is not str:
    ...
    def updateCard(self):
        ...
        if type(updateCard['number']) is not str and type(updateCard['month']) is not str and type(
                updateCard['year']) is not str and type(updateCard['CVV']) is not str:
            return 'Invalid type of data request!'
