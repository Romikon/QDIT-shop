...
class UserRoutesController:
    ...
    def Routes(self):
        userRotesController.add_url_rule('/getusers', view_func=self.getUsers, methods=['GET'])
        userRotesController.add_url_rule('/adduser', view_func=self.addUser, methods=['POST'])
        userRotesController.add_url_rule('/updateuser/<id>', view_func=self.updateUser, methods=['PATCH'])
        userRotesController.add_url_rule('/deleteuser/<id>', view_func=self.deleteUser, methods=['DELETE'])
